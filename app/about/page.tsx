...
const TrialBookingModal = dynamic(() => import("@/components/TrialBookingModal"), { ssr: false });
import {
  ShieldCheck,
  Dumbbell,
  Users,
...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-[#070707] text-[#F3F4F6] selection:bg-[#E5A919] selection:text-black">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                ...
                >
                  <div className="relative h-56 rounded-2xl overflow-hidden border border-zinc-800 group">
                    <Image src="/img/8.jpeg" alt="Community workout" fill sizes="(max-width: 768px) 50vw, 300px" loading="lazy" decoding="async" className="object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="relative h-56 rounded-2xl overflow-hidden border border-zinc-800 group mt-6">
                    <Image src="/img/5.jpeg" alt="1-on-1 coaching" fill sizes="(max-width: 768px) 50vw, 300px" loading="lazy" decoding="async" className="object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="relative h-56 rounded-2xl overflow-hidden border border-zinc-800 group">
                    <Image src="/img/3.jpeg" alt="Lifting session" fill sizes="(max-width: 768px) 50vw, 300px" loading="lazy" decoding="async" className="object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="relative h-56 rounded-2xl overflow-hidden border border-zinc-800 group mt-6">
                    <Image src="/img/6.jpeg" alt="Functional training" fill sizes="(max-width: 768px) 50vw, 300px" loading="lazy" decoding="async" className="object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
                </motion.div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                  ...
                  <div className="pt-4 border-t border-zinc-800 flex items-center gap-3">
                    <div className="relative w-10 h-10 rounded-full overflow-hidden border border-[#E5A919]">
                      <Image src="/images/trans_1.jpg" alt="Rahul" fill sizes="40px" loading="lazy" decoding="async" className="object-cover object-top" />
                    </div>
                    <div>
                ...
                >
                  ...
                  <div className="pt-4 border-t border-zinc-800 flex items-center gap-3">
                    <div className="relative w-10 h-10 rounded-full overflow-hidden border border-[#E5A919]">
                      <Image src="/images/trans_2.jpg" alt="Pooja" fill sizes="40px" loading="lazy" decoding="async" className="object-cover object-top" />
                    </div>
                    <div>
                ...
                >
                  ...
                  <div className="pt-4 border-t border-zinc-800 flex items-center gap-3">
                    <div className="relative w-10 h-10 rounded-full overflow-hidden border border-[#E5A919]">
                      <Image src="/images/trans_3.jpg" alt="Karthik" fill sizes="40px" loading="lazy" decoding="async" className="object-cover object-top" />
                    </div>
                    <div>
      ...
      {/* 1-on-1 Trial Modal (Loaded on demand) */}
      {isTrialModalOpen && (
        <TrialBookingModal
