  ...
  return (
    <div className="min-h-screen bg-[#070707] text-[#F3F4F6] selection:bg-[#E5A919] selection:text-black">
      ...
      <main className="pt-28 pb-20">
        ...
        {/* Branches Showcase & Inquiry Form Grid (Loaded on viewport approach) */}
        ...
        {/* FAQ Accordion Section (Loaded on viewport approach) */}
        <LazySection minHeight="400px" id="faq">
